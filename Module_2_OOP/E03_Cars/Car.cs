...
public class Car
{
    ...
    */
    ...
    internal static string ReadSelectedOption() => Console.ReadLine();
    ...
    internal static bool ValidateOption(string selectedOption, bool fullMenu)
    {
        ...
        if (menuOptions.ContainsKey(selectedOption)) return true;
    ...
    internal string ValidateLicense(string userValue)
    {
        ...
        if (!match.Success) return License;
    ...
    ~Car() => Console.WriteLine("O carro vai para a sucata...");
